...
int primeNumbers[]={97,193,389,577,1217,1549,2017,4049,8009,10007,15331,30047,50021,75029,100003,150001,200003,385027,500009,1000003,2000003,4000011,8000009,16000057};
...
int hashTable::insert(const std::string &key, void *pv){
    if (hashTable::contains(key)==true){
        ...
        if(capacity>filled){
            ...
            //If occupied by a not deleted node, go to next/*
            ...
            std::cout << "I AM GOING TO REHASH BECAUSE FILLED|CAPCITY: " << filled << " | " << capacity << std::endl;
            hashTable::rehash();
            return 2;
        }
    }           
